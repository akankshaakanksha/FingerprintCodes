"SEGMENTATION STEP IN FINGERPRINT ENHANCEMENT"
...
def create_segmented_and_variance_images(im, W, threshold):
    ...
    for i in range(0, x, W):
        for j in range(0, y, W):
            ...
            block_variance = ImageStat.Stat(im.crop(box)).stddev[0]
            variance_image.paste(block_variance, box)
...
parser.add_argument("threshold", nargs=1, help = "Threshold on stddev for accepting / rejecting blocks")
